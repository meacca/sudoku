...
class sudoku():
    ...
    def configure_window(self):
        ...
        hint_btn.grid(column=3*self.params["btn_size"] -
                      self.params["btn_size"]//2,
                      row=0,
                      columnspan=self.params["btn_size"],
                      sticky=tk.N+tk.E+tk.S+tk.W)
        ...
        check_btn.grid(column=5*self.params["btn_size"] +
                       self.params["btn_size"]//2,
                       row=0,
                       columnspan=self.params["btn_size"],
                       sticky=tk.N+tk.E+tk.S+tk.W)
        ...
        exit_btn = tk.Button(self.window, text='Exit',
                             ...
                             bg="white", fg="black", font=self.params["font"])
        exit_btn.grid(column=8*self.params["btn_size"] -
                      self.params["btn_size"]//2,
                      row=0,
                      columnspan=self.params["btn_size"],
                      sticky=tk.N+tk.E+tk.S+tk.W)
